...
const Footer = ()=>{
  ...
  return (
    <footer className="bg-gray-400 dark:bg-gray-700 w-full">
      <div className="container p-6 mx-auto">
        <div className="lg:flex">
          <div className="w-full -mx-6 lg:w-2/5">
            <div className="px-6">
              <div>
                <h3 className="text-2xl text-gray-700 dark:text-white hover:text-gray-700 dark:hover:text-gray-300">Ronewa Inc</h3>
              </div>
                ...
                <div className="flex mt-6 -mx-2">
                  <Link to="#" className="mx-2 text-gray-600 transition-colors duration-300 dark:text-gray-300 hover:text-blue-500 dark:hover:text-blue-400" aria-label="Twitter">
                    <BsTwitter className="w-5 h-5 fill-current"/>
                  </Link>
                    <Link to="#" className="mx-2 text-gray-600 transition-colors duration-300 dark:text-gray-300 hover:text-blue-500 dark:hover:text-blue-400" aria-label="Linkedin">
              ...
              <div className="mt-6 lg:mt-0 sm:flex-col lg:flex-1">
                <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
                  ...
                  <div>
                    ...
                    <span className="block mt-2 text-sm text-gray-600 dark:text-gray-400 hover:underline">(+27) 78 667 1901</span>
                    <span className="block mt-2 text-sm text-gray-600 dark:text-gray-400 hover:underline">ronewamavhungu@email.com</span>
                  </div>
                </div>
              </div>
          </div>
          ...
          <div>
            <p className="text-center text-gray-500 dark:text-gray-400">© Ronewa Inc {date} - All rights reserved</p>
          </div>
      </div>
    </footer>
  )
