        ...
        <div className="w-full max-w-md space-y-8">
            ...
            <form className="mt-8 space-y-6" action="#" method="POST">
                ...
                <div className="-space-y-px rounded-md shadow-sm">
                    <div>
                        <label for-email="email-address" className="sr-only">Email address</label>
                    ...
                    <div>
                        <label for-password="password" className="sr-only">Password</label>
                ...
                <div className="flex items-center justify-between">
                    <div className="flex items-center">
                        ...
                        <label for-remember-me="remember-me" className="ml-2 block text-sm text-gray-900">Remember me</label>
                    </div>
